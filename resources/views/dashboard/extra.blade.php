            ...
            <table class="table table-flush" id="datatable-basic">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <button  class="btn btn-info"><a href="/dataextrakulikuler/{{ $d->id }}" style="color: black;"><i class="fas fa-eye"></i></a></button>
                            <button  class="btn btn-success"><a href="/dataextrakulikuler/{{ $d->id }}/edit" class="text-white" style="color: white;"><i class="fas fa-edit"></i></a></button>
                            <form action="/dataextrakulikuler/{{ $d->id }}" method="POST" style="display: inline-block;">
                                @csrf
                                @method('DELETE')
                                <button  type="submit" class="btn btn-danger"><a style="color: white;"><i class="fas fa-trash"></i></a></button>
                            </form>
                        </td>
                    </tr>
                    @endforeach
